...
return (
    <div className="text-center mb-4" style={{ maxWidth: 960, width: '100%' }}>
      <img src={logo} alt="Logo" style={{ height: '100px', marginBottom: '10px', border: '3px solidrgb(19, 18, 18)', borderRadius: 12, background: '#fff7f3', padding: 12 }} />
      ...
      <h3 style={{ color: 'black', fontWeight: 800, marginBottom: 8 }}>
  Convocation Form
</h3>
    </div>
  );
